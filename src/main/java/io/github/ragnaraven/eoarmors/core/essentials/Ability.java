...
public enum Ability
{
	...
	{
		if (getLevel(nbt) == 2)
			return new TextComponent("eoarmors.ability." + this.toString()).getString() + " II";
		else if (getLevel(nbt) == 3)
			return new TextComponent("eoarmors.ability." + this.toString()).getString() + " III";
		else
			return new TextComponent("eoarmors.ability." + this.toString()).getString();
	}
	...
	{
		return new TextComponent("eoarmors.ability.type." + type.toString()).getString();
	}
