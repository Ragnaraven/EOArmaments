package io.github.ragnaraven.eoarmaments.client.render.particles;
...
public class ParticleEffects
{
	...
	public static void spawnEnderObsidianBlockParticles(Level world, double x, double y, double z)
	{
		...
		//spawnEnderObsidianParticles(world, x, y, z);
	}
	
	public static void spawnEnderObsidianSpawnParticles(Level world, double x, double y, double z)
	{
		...
		world.addParticle(new EOAParticles.EnderObsidianParticleData(), x, y, z, 0, 0, 0);
	}
	
	public static void spawnEnderObsidianParticles(Entity entity, double x, double y, double z, float f, float f1, float f2)
	{
		entity.getCommandSenderWorld().addParticle(new EOAParticles.EnderObsidianParticleData(), x, y, z, 0, 0, 0);
	}
	...
	public static void spawnEnderObsidianParticles(Entity entity, int quantity)
	{
		for (int i = 0; i < quantity; i++)
		{
			entity.getCommandSenderWorld().addParticle(
					...
					new EOAParticles.EnderObsidianParticleData(),
